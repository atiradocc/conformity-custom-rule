...
parser = argparse.ArgumentParser(
    description='Deletes a C1 Conformity Custom Rule. See https://cloudone.trendmicro.com/docs/conformity/in-preview-custom-rules-overview/#using-custom-rules')
...
response = requests.delete(url=conformityEndpoint, headers=header)
